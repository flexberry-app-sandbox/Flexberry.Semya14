...
namespace IIS.Semya14
{
    ...
    public class Датчик : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Semya14.Контроллер fКонтроллер;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Semya14.Контроллер.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Контроллер"})]
        public virtual IIS.Semya14.Контроллер Контроллер
        {
            get
            {
                ...
                IIS.Semya14.Контроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДатчикE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДатчикE", typeof(IIS.Semya14.Датчик));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДатчикL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДатчикL", typeof(IIS.Semya14.Датчик));
                }
            }
        }
    }
    ...
    public class DetailArrayOfДатчик : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Semya14.DetailArrayOfДатчик members)

        // *** End programmer edit section *** (IIS.Semya14.DetailArrayOfДатчик members)
        ...
        /// </summary>
        public DetailArrayOfДатчик(IIS.Semya14.Контроллер fКонтроллер) : 
                base(typeof(Датчик), ((ICSSoft.STORMNET.DataObject)(fКонтроллер)))
        {
        }
        
        public IIS.Semya14.Датчик this[int index]
        {
            get
            {
                return ((IIS.Semya14.Датчик)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Semya14.Датчик dataobject)
        {
